...
const About = (props)=>{
    return(
        <section className="container-fluid about-section">
            <div className="row">
                <img className=" bb d-none d-lg-block col-lg-4 p-0 aboutImgLeft" src={props.aboutImgLeft} alt="" />
            ...
            <img className=" nn d-none d-lg-block col-lg-4 p-0  aboutImgRight " src={props.aboutImgRight} alt="" />
            </div>
        </section>
    );
}
